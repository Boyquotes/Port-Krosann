...
func _on_ButtonSell_button_up():
	if kind == Good.Goods.Grain:
		if Player.grainAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.grainSellPrice
			Market.current.grainAmount += 1
			Player.grainAmount -= 1
			Ship.current.currCargo -= 1
			if Player.grainAmount <= 0:
				Player.grainAveragePrice = 0

	elif kind == Good.Goods.Corn:
		if Player.cornAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.cornSellPrice
			Market.current.cornAmount += 1
			Player.cornAmount -= 1
			Ship.current.currCargo -= 1
		...
		if Player.vegetablesAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.vegetablesSellPrice
			Market.current.vegetablesAmount += 1
			Player.vegetablesAmount -= 1
			Ship.current.currCargo -= 1
			if Player.vegetablesAmount <= 0:
				Player.vegetablesAveragePrice = 0

	elif kind == Good.Goods.Fruits:
		if Player.fruitsAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.fruitsSellPrice
			Market.current.fruitsAmount += 1
			Player.fruitsAmount -= 1
			Ship.current.currCargo -= 1
			if Player.fruitsAmount <= 0:
				Player.fruitsAveragePrice = 0

	elif kind == Good.Goods.Cotton:
		if Player.cottonAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.cottonSellPrice
			Market.current.cottonAmount += 1
			Player.cottonAmount -= 1
			Ship.current.currCargo -= 1
			if Player.cottonAmount <= 0:
				Player.cottonAveragePrice = 0

	elif kind == Good.Goods.Beer:
		if Player.beerAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.beerSellPrice
			Market.current.beerAmount += 1
			Player.beerAmount -= 1
			Ship.current.currCargo -= 1
		...
		if Player.bricksAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.bricksSellPrice
			Market.current.bricksAmount += 1
			Player.bricksAmount -= 1
			Ship.current.currCargo -= 1
			if Player.bricksAmount <= 0:
				Player.bricksAveragePrice = 0

	elif kind == Good.Goods.Cocoa:
		if Player.cocoaAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.cocoaSellPrice
			Market.current.cocoaAmount += 1
			Player.cocoaAmount -= 1
			Ship.current.currCargo -= 1
			if Player.cocoaAmount <= 0:
				Player.cocoaAveragePrice = 0

	elif kind == Good.Goods.Coffee:
		if Player.coffeeAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.coffeeSellPrice
			Market.current.coffeeAmount += 1
		...
		if Player.sugarAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.sugarSellPrice
			Market.current.sugarAmount += 1
			Player.sugarAmount -= 1
			Ship.current.currCargo -= 1
			if Player.sugarAmount <= 0:
				Player.sugarAveragePrice = 0

	elif kind == Good.Goods.Tabacco:
		if Player.tabaccoAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.tabaccoSellPrice
			Market.current.tabaccoAmount += 1
			Player.tabaccoAmount -= 1
			Ship.current.currCargo -= 1
			if Player.tabaccoAmount <= 0:
				Player.tabaccoAveragePrice = 0

	elif kind == Good.Goods.Silk:
		if Player.silkAmount > 0 and Ship.current.currCargo > 0:
			Player.gold += Market.current.silkSellPrice
			Market.current.silkAmount += 1
			Player.silkAmount -= 1
			Ship.current.currCargo -= 1
...
func _on_ButtonBuy_button_up():
	if kind == Good.Goods.Grain:
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.grainBuyPrice and Market.current.grainAmount > 0:
				Player.gold -= Market.current.grainBuyPrice
				Market.current.grainAmount -= 1
				Player.grainAmount += 1
				Ship.current.currCargo += 1
				if Player.grainAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.cornBuyPrice and Market.current.cornAmount > 0:
				Player.gold -= Market.current.cornBuyPrice
				Market.current.cornAmount -= 1
				Player.cornAmount += 1
				Ship.current.currCargo += 1
				if Player.cornAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.vegetablesBuyPrice and Market.current.vegetablesAmount > 0:
				Player.gold -= Market.current.vegetablesBuyPrice
				Market.current.vegetablesAmount -= 1
				Player.vegetablesAmount += 1
				Ship.current.currCargo += 1
				if Player.vegetablesAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.fruitsBuyPrice and Market.current.fruitsAmount > 0:
				Player.gold -= Market.current.fruitsBuyPrice
				Market.current.fruitsAmount -= 1
				Player.fruitsAmount += 1
				Ship.current.currCargo += 1
				if Player.fruitsAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.cottonBuyPrice and Market.current.cottonAmount > 0:
				Player.gold -= Market.current.cottonBuyPrice
				Market.current.cottonAmount -= 1
				Player.cottonAmount += 1
				Ship.current.currCargo += 1
				if Player.cottonAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.beerBuyPrice and Market.current.beerAmount > 0:
				Player.gold -= Market.current.beerBuyPrice
				Market.current.beerAmount -= 1
				Player.beerAmount += 1
				Ship.current.currCargo += 1
				if Player.beerAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.bricksBuyPrice and Market.current.bricksAmount > 0:
				Player.gold -= Market.current.bricksBuyPrice
				Market.current.bricksAmount -= 1
				Player.bricksAmount += 1
				Ship.current.currCargo += 1
				if Player.bricksAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.cocoaBuyPrice and Market.current.cocoaAmount > 0:
				Player.gold -= Market.current.cocoaBuyPrice
				Market.current.cocoaAmount -= 1
				Player.cocoaAmount += 1
				Ship.current.currCargo += 1
				if Player.cocoaAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.coffeeBuyPrice and Market.current.coffeeAmount > 0:
				Player.gold -= Market.current.coffeeBuyPrice
				Market.current.coffeeAmount -= 1
				Player.coffeeAmount += 1
				Ship.current.currCargo += 1
				if Player.coffeeAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.sugarBuyPrice and Market.current.sugarAmount > 0:
				Player.gold -= Market.current.sugarBuyPrice
				Market.current.sugarAmount -= 1
				Player.sugarAmount += 1
				Ship.current.currCargo += 1
				if Player.sugarAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.tabaccoBuyPrice and Market.current.tabaccoAmount > 0:
				Player.gold -= Market.current.tabaccoBuyPrice
				Market.current.tabaccoAmount -= 1
				Player.tabaccoAmount += 1
				Ship.current.currCargo += 1
				if Player.tabaccoAveragePrice > 0:
		...
		if Ship.current.currCargo + 1 < Ship.current.maxCargo:
			if Player.gold >= Market.current.silkBuyPrice and Market.current.silkAmount > 0:
				Player.gold -= Market.current.silkBuyPrice
				Market.current.silkAmount -= 1
				Player.silkAmount += 1
				Ship.current.currCargo += 1
				if Player.silkAveragePrice > 0:
